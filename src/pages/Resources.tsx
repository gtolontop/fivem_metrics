...
import { Package, Server, Filter, Loader2 } from 'lucide-react'
    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      >
        ...
        <p className="text-secondary">
          Discover the most used FiveM resources
        </p>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm">
            ...
            <span className="text-muted"> unique resources</span>
          </span>
        </div>
        <div className="flex items-center gap-2">
